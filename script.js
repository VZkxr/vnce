...
const catalogoPeliculas = [
...

    {
        ...
        genero: ['Familia', 'Aventura', 'Animación'],
        calificacion: 7.8,
        duracion: "104 min",
...

    {
        ...
        tipo: "Serie",
        sinopsis: `En 1958, un grupo de siete amigos están empezando a ver cosas extrañas en el tranquilo pueblito Derry. Con el tiempo, descubren que todos estaban viendo lo mismo: un ser sobrenatural y malvado que puede adoptar muchas formas.`,
        genero: ['Terror', 'Mistero'],
        calificacion: 7.935,
        duracion: "8 episodios",
        elenco: ['Taylour Paige', 'Jovan Adepo', 'James Remar', 'Stephen Rider', 'Matilda Lawler'],
        portada: "https://image.tmdb.org/t/p/original/vC6LSYC8uhZPkPM01L6HKrr1lMD.jpg",
